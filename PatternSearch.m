function [bestOpt, bestOdf] = PatternSearch(bigStep, smallStep)

fhandle =@SeparateOptY;
fileName = strcat('patternDat',num2str(bigStep),'_',num2str(smallStep),'.mat');
